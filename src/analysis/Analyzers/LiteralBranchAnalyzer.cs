...
namespace SatorImaging.MeticulousAnalyzer.Analysis.Analyzers
{
    ...
    public sealed class LiteralBranchAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Rule_LiteralBranch = new(
            ...
            description: new LocalizableResourceString(nameof(Resources.SMA8020_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_LiteralBranchZero = new(
            ...
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA8021_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_LiteralBranchString = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA8022_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_LiteralBranchChar = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA8023_MessageFormat), Resources.ResourceManager, typeof(Resources)));
