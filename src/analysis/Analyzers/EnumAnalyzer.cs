...
namespace SatorImaging.MeticulousAnalyzer.Analysis.Analyzers
{
    ...
    public sealed class EnumAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Rule_CastToEnum = new(
            ...
            description: new LocalizableResourceString(nameof(Resources.SMA0020_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_CastFromEnum = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0021_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_CastToGenericEnum = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0022_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_CastFromGenericEnum = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0023_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_EnumToString = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0024_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_EnumMethod = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0025_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_EnumObfuscation = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0026_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_UnusualEnum = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0027_MessageFormat), Resources.ResourceManager, typeof(Resources)));
        ...
        private static readonly DiagnosticDescriptor Rule_EnumLike = new(
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0028_MessageFormat), Resources.ResourceManager, typeof(Resources)));
#endif
