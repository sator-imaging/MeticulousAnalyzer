...
namespace Test
{
    public class CTest
    {
        ...
        public void Test()
        {
            ...
            Bar(1, {|#3:2|});
            Bar(1, {|#5:2|}, {|#6:3|});
            var x = new CTest(1, {|#8:2|});
            var y = new CTest(1, {|#10:2|}, {|#11:3|});
        }
...
";
            ...
            await VerifyCS.VerifyAnalyzerAsync(test, expected1, expected3, expected5, expected6, expected8, expected10, expected11);
        }
