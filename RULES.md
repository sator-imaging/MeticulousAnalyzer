...
| ID      | Diagnostic                                 | Description
|---------|--------------------------------------------|-------------
| SMA0080 | Internal cross-namespace access            | Internal types and members must not be accessed from a different namespace, including parent or sibling namespaces. (Exceptions: "Core" leaf namespace, "SR" type, and internal attribute types used in attribute syntax. Internal types declared in the same namespace as the attribute are also allowed as arguments)
