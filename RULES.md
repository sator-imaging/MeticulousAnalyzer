...
| | | |
| SMA8020 | Literal branch number                      | Avoid hardcoded literals in comparison or branch conditions for better maintainability. Can suppress by adding a trailing comment after the literal (e.g. `value == 42 /* Why */`).
