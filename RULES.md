...
Auto-generated by `DocsGen, Version=5.1.0.0, Culture=neutral, PublicKeyToken=null`  
...
| SMA0033 | Invalid [NoCopy] Type Definition                              | [NoCopy] type must be a struct or record struct and implement a public parameterless Move() method returning itself.
| SMA0034 | Prohibited Copy of [NoCopy] Type                              | [NoCopy] type cannot be copied; pass by reference or call .Move() to transfer ownership.
| SMA0035 | Prohibited Ref/Out Parameter of [NoCopy] Type in Async Method | Passing [NoCopy] type by ref or out is not allowed inside async methods or async lambda expressions.
