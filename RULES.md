...
| ID      | Diagnostic                                 | Description
|---------|--------------------------------------------|-------------
| SMA8000 | Literal should be passed as named argument | Literal arguments should be passed as named arguments to express their meaning. (Exception: methods and constructors in the System namespace with only one argument are exempt)
