...
- [RULES.md](RULES.md): [File Header Comment Enforcement](RULES.md#file-structure-analysis), [Coding Assistance](RULES.md#coding-assistance) and more, all diagnostic rules.
