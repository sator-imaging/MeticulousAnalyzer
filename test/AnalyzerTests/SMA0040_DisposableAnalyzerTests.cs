...
namespace Test
{
    class Program
    {
        ...
        {
            // Don't dispose
            var d = (object)(IDisposable)value;
        }
    }
}
";
...
namespace Test
{
    ...
    class Program
    {
        void Method()
        {
            do { } while (new MyDisposable() != null);
        }
    }
}
";
