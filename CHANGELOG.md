...
### ✨ Bug Fixes
* Fix `SMA7001` code fix for parenthesized static method references and ref/out modifiers by [@google-labs-jules](https://github.com/google-labs-jules)[bot] in [#675](https://github.com/sator-imaging/MeticulousAnalyzer/pull/675)
...
### 🚀 Features
* Add `MidFlowBranchAnalyzer` (SMA8030) by [@google-labs-jules](https://github.com/google-labs-jules)[bot] in [#530](https://github.com/sator-imaging/MeticulousAnalyzer/pull/530)
...
* Add `SMA8004` System namespace and CancellationToken exemption by [@google-labs-jules](https://github.com/google-labs-jules)[bot] in [#560](https://github.com/sator-imaging/MeticulousAnalyzer/pull/560)
...
* Update MidFlowBranchAnalyzer section in README (en/ja/zh) by [@google-labs-jules](https://github.com/google-labs-jules)[bot] in [#629](https://github.com/sator-imaging/MeticulousAnalyzer/pull/629)
### 📚 Other Changes
...
* Refactor while loops to do-while loops when condition met at start by [@google-labs-jules](https://github.com/google-labs-jules)[bot] in [#630](https://github.com/sator-imaging/MeticulousAnalyzer/pull/630)


**Full Changelog**: https://github.com/sator-imaging/MeticulousAnalyzer/compare/v5.1.0...v5.2.0
