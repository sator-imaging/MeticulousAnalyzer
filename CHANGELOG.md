...
* test: add missing EnumAnalyzer tests from sandbox/EnumTests.cs by [@kiro-agent](https://github.com/kiro-agent)[bot] in [#335](https://github.com/sator-imaging/StaticMemberAnalyzer/pull/335)
* Add missing DisposableAnalyzer tests from sandbox/DisposableTests.cs by [@kiro-agent](https://github.com/kiro-agent)[bot] in [#336](https://github.com/sator-imaging/StaticMemberAnalyzer/pull/336)
