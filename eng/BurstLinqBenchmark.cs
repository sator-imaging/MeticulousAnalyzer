...
// Find the runfile .csproj generated by `dotnet run` for this file-based app.
// BenchmarkDotNet's CsProjGenerator needs to locate it for out-of-process builds.
var runfileDir = Path.Combine(
...
// Change working directory so BenchmarkDotNet can find the .csproj
if (projectDir != null)
...
var config = ManualConfig.Create(DefaultConfig.Instance)
    .AddJob(Job.ShortRun
        .WithToolchain(CsProjCoreToolchain.From(
            new NetCoreAppSettings("net10.0", null, "net10.0")))
        .WithId("net10.0"))
    .AddJob(Job.ShortRun
        .WithToolchain(CsProjCoreToolchain.From(
